...
if __name__ == '__main__':
    ...
    # load and sort stuff
    c3rLDA_nzwc = np.load(f"/scratch/tc2vg/c3rLDA_model_runs/all_eths_less_than_15000_1000_its_{num_topics}_topics/nzwc.npy")
    ...
    with open(f'./coherence_results/palmetto-c3rLDA-{num_topics}.json', 'w') as outfile:
